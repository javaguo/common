...
Ext.define('Platform.form.field.VTypes', {
    ...
    letterNumMask:/^[A-Za-z0-9]+$/i,

    //26个英文字母、数字、下划线
    letterNumNnderline: function(value) {
        return this.letterNumNnderlineRe.test(value);
    },
    letterNumNnderlineRe:/^\w+$/,
    letterNumNnderlineText:'只能输入英文字母、数字、下划线',
    letterNumNnderlineMask:/^\w+$/i,
    ...
    chineseletterNumMask:/^[\u4E00-\u9FA5A-Za-z0-9]+$/i,

    //中文、26个英文字母、数字、下划线
    chineseletterNumNnderline: function(value) {
        return this.chineseletterNumNnderlineRe.test(value);
    },
    chineseletterNumNnderlineRe:/^[\u4E00-\u9FA5A-Za-z0-9_]+$/,
    chineseletterNumNnderlineText:'只能输入汉字、英文字母、数字、下划线',
    chineseletterNumNnderlineMask:/^[\u4E00-\u9FA5A-Za-z0-9_]+$/i,
    ...
    emailPlatformMask:/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/i,

    //手机号码
    mobileNo: function(value) {
        return this.mobileNoRe.test(value);
    },
    mobileNoRe:/^(13[0-9]|14[0-9]|15[0-9]|18[0-9])\d{8}$/,
    mobileNoText:'手机号码不合法，（只能输入13、14、15、18）开头的手机号',
    mobileNoMask:/^(13[0-9]|14[0-9]|15[0-9]|18[0-9])\d{8}$/,
    ...
    phoneNoText:'电话号码不合法，正确格式如下：区号-电话号或电话号',
    phoneNoMask:/^(\d{3,4}-|\d{3,4}-)?\d{7,8}$/,

	//手机号或电话号码
    phoneNoMobileNo: function(value) {
        return this.phoneNoMobileNoRe.test(value);
    },
    phoneNoMobileNoRe:/(^(\d{3,4}-|\d{3,4}-)?\d{7,8}$)|(^(13[0-9]|14[0-9]|15[0-9]|18[0-9])\d{8}$)/,
    ...
    IDNumber15Mask:/^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$/,	
    ...
    IDNumber18Mask:/^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/,
    ...
    accountNumberText:'不合法的账号(正确格式为：字母开头，允许5-16字节，允许字母数字下划线)',
    accountNumberMask:/^[a-zA-Z][a-zA-Z0-9_]{4,15}$/,	

	//密码(以字母开头，长度在6~18之间，只能包含字母、数字和下划线)
    defaultPassword: function(value) {
        return this.defaultPasswordRe.test(value);
    },
    defaultPasswordRe:/^[a-zA-Z]\w{5,17}$/,
    defaultPasswordText:'不合法的密码（正确格式密码：以字母开头，长度在6~18之间，只能包含字母、数字和下划线）',
    defaultPasswordMask:/^[a-zA-Z]\w{5,17}$/,
    ...
    strongPasswordMask:/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,10}$/	    
});